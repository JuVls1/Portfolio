...
-- 8. Quelle est l'option d'expédition la plus populaire et le délai moyen entre la commande et l'expédition pour chacune de ces options ?
...
-- 9. Quel est le produit le plus vendu par région du monde ? par région de France ?
with CTE as 
